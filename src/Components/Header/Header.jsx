            ...
            <div className='flex items-center mt-4 lg:mt-0'>
              ...
              <div>
                ...
                <button onClick={() => { setShowProfile(!showProfile) }}>
                  <img alt="Profile Img" src="https://img.freepik.com/premium-vector/man-avatar-profile-picture-vector-illustration_268834-538.jpg" className=" h-12 w-12 cursor-pointer rounded-full active:scale-95 transition-all scale-125" />
                </button>
                ...
                {showProfile &&
                  <ul className="absolute mt-2 z-10 flex min-w-[180px] flex-col gap-2 overflow-auto rounded-md border border-blue-gray-50 bg-white p-3 font-poppins shadow-lg " >
                    ...
                    <button onClick={() => { navigate("/profile") }} className="py-2 cursor-pointer active:scale-95 text-gray-700 rounded-md lg:mt-0 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 text-xl flex justify-center items-center gap-2 transition-all" >
                      <CgProfile />
                    ...
                    <button className="py-2 cursor-pointer active:scale-95 text-gray-700 rounded-md lg:mt-0 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 text-xl flex justify-center items-center gap-2 transition-all" >
                      <FaSignOutAlt />
