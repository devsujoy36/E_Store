        ...
        <section class="bg-white dark:bg-gray-900 md:mx-0 mx-5" >
            <div class="container flex items-center justify-center min-h-[70vh] px-6 mx-auto">
                <form class="w-full max-w-md">
                    ...
                    <h1 class="mt-3 text-2xl font-semibold text-gray-800 capitalize sm:text-3xl dark:text-white">Log In</h1>
                    ...
                    <div class="mt-6">
                        ...
                        <p class="mt-4 text-center text-gray-600 dark:text-gray-400">or log in with</p>
