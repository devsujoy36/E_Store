            ...
            <div className="flex justify-center items-center ">
                <div className="max-w-[720px] mx-auto">
                    ...
                    <div className="relative flex w-full max-w-[26rem] flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg">
                        <div
                            className="relative mx-4 mt-4 overflow-hidden text-white shadow-lg rounded-xl bg-blue-gray-500 bg-clip-border shadow-blue-gray-500/40 cursor-pointer">
                            <img
                        ...
                        <div className="p-6 pt-3 flex justify-between md:text-md text-xs items-center gap-10">
                            <button
                                className="bg-black text-white font-semibold w-full py-3.5 px-7 rounded-xl cursor-pointer hover:shadow-xl active:shadow-none active:scale-95 transition-all "
                                type="button">
                                Source Code
                            </button>
                            <button
