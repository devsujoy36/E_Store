                ...
                <div class="container flex items-center justify-center min-h-[70vh] px-6 mx-auto">
                    <form class="w-full max-w-md">
                        ...
                        <div class="relative flex items-center mt-8">
                            <CgProfile className="absolute m-2 text-2xl text-gray-300" />

                            <input type="text" class="block w-full py-3 text-gray-700 bg-white border rounded-lg px-11 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Full Name" />
                        </div>
                        ...
                        <div class="mt-6">
                            <button class="w-full px-6 py-3 cursor-pointer text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-500 rounded-lg hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                                Sign Up
                            </button>
